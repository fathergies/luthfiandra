...
export function ForYouPage() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#fff8ef] text-[#351923]">
      ...
      <footer className="bg-[#790826] px-5 py-12 text-center text-white"><p className="font-serif text-2xl font-black italic">come back whenever you need me. ♡</p><Link href="/garage" className="mt-5 inline-block border-b border-white/60 font-mono text-[9px] uppercase tracking-widest">← back to garage</Link></footer>
